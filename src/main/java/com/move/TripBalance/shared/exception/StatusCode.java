...
public enum StatusCode {
    ...
    NOT_FOUND(HttpStatus.BAD_REQUEST,"121","존재하지 않는 게시글 id 입니다."),

    BAD_REQUEST(HttpStatus.BAD_REQUEST,"122","작성자만 수정할 수 있습니다."),

    BAD_REQUEST_COMMENT(HttpStatus.BAD_REQUEST,"123","존재하지 않는 댓글 id 입니다."),

    BAD_REQUEST_RECOMMENT(HttpStatus.BAD_REQUEST,"124","존재하지 않는 대댓글 id 입니다."),
